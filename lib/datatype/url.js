...
var url = {
  ...
  getProviderTokenURL: function getProviderTokenURL() {
    return _config2['default'].getProviderTokenURL;
  },
  getLoginInfoURL: function getLoginInfoURL(token) {
    var url = _config2['default'].getLoginInfoURL + '?provider_access_token=' + token;
    return url;
  },
